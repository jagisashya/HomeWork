...
public class ApplAlarmClock {
	...
	public static void main(String[] args) throws InterruptedException {
		ApplAlarmClock stam = new ApplAlarmClock();
		// ApplAlarmClock.Functions stam = x.new 
//		ApplAlarmClock.Stam stam1 = new ApplAlarmClock.Stam();
//		Scanner input = new Scanner(System.in);
		System.out.println("Enter with the time:");
		SimpleTime timeEzer = stam.inputTime();
